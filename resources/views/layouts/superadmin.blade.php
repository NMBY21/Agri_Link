...
<head>
    ...
    <title>Agri Link - Superadmin</title>
    ...
    <link href="{{ asset('superadmin/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/superadmin/dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">Hello, Farmer</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Carik Bali 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{ asset('superadmin/js/sb-admin-2.min.js') }}"></script>
    ...
    <script src="{{ asset('superadmin/js/demo/chart-pie-demo.js') }}"></script>
    ...
    <!-- Page level custom scripts -->
    <script src="{{ asset('superadmin/js/demo/datatables-demo.js') }}"></script>
