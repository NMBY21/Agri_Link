        ...
        <div class="shipping-bg">
            <div class="row shipping-wrap">
                ...
                <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                    <div class="shipping-item">
                        <div class="shipping-img">
                            <img src="{{ asset('customer/assets/images/shipping/icon/service.png') }}"
                                alt="Shipping Icon">
                        </div>
                        <div class="shipping-content">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="{{ url('/customer/product') }}/{{ $item->id }}">
                                            <img class="primary-img"
                                                src="{{ asset('img_uploads/thumbnail/'.$item->thumbnail_img) }}"
                                                alt="Product Images">
                                    ...
                                    <div class="product-content">
                                        <a class="product-name" href="{{ url('/customer/product') }}/{{ $item->id }}">{{
                                            $item->name_product }}</a>
